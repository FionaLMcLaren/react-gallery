...
export default function ErrorMessage({ message, isAdmin }) {
    return (
        <Fragment>
            <div className="flex items-center animate-jump-in">
                <ErrorSplash className="relative h-52 w-52 -rotate-180"/>
            ...
            <div className="flex flex-col gap-3 items-center
                ...
                <span className="font-display font-bold tracking-wider text-3xl mt-10">ERROR: Spilled Ink!</span>
                <span>{message}</span>
